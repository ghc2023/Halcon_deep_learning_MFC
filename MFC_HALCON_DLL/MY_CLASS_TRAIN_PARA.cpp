...
void CMY_CLASS_TRAIN_PARA::OnBnClickedButtonSaveClassTrainPara()
{
	...
	GetDlgItem(IDC_EDIT_update_images_interval_epochs4)->GetWindowText(cs_BestModelBaseName);
	GetDlgItem(IDC_EDIT_update_images_interval_epochs5)->GetWindowText(cs_FinalModelBaseName);
